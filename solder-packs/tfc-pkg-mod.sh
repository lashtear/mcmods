...
# base config
( cd $HOME/git/mtfc17-conf.git; git tag $MPNAME-$MPVERSION )
gitfile "$HOME/git/mtfc17-conf.git" config "$MPNAME-$MPVERSION"
( cd $HOME/git/mechanipus-resource-pack.git; git tag $MPNAME-$MPVERSION )
stagegitfile "$HOME/git/mechanipus-resource-pack.git" mechanipus "$MPNAME-$MPVERSION"
solderfile --staged --client mechanipus.zip mechanipus-resource-pack "$MPVERSION" resourcepacks mechanipus.zip

# lex manos
solderfile --client forge-1.7.10-10.13.2.1258-universal.jar forge 10.13.2.1258 bin modpack.jar
...
solderfile '[1.7.10]TerraFirmaCraft-0.79.13.468.jar' terrafirmacraft 0.79.13.468

solderfile 'TerraFirmaCraftNEIplugin-1.7.10-1.2.0.9.jar' tfc-nei-plugin 1.2.0.9
solderfile '[1.7.10]Lanterns-1.0.42.jar' tfc-lanterns 1.0.42
solderfile '[1.7.10]LeatherWaterSac-3.4.B79.jar' tfc-leather-water-sac 3.4.B79
solderfile 'MineTweaker3-1.7.10-3.0.9C.jar' mine-tweaker 3.0.9C
solderfile 'ModTweaker-1.7.X-0.6-0.jar' mod-tweaker 0.6-0

#stagezipdata 'PresenceFootsteps_r5b__1_7_10.zip'
#solderfile --staged --client 'mods/1.7.10/PresenceFootsteps_r5b__1.7.10.litemod' presence-footsteps r5b mods/1.7.10 PresenceFootsteps_r5b__1.7.10.litemod
#solderfile --staged --client 'resourcepacks/PresenceFootstepsOfficial.zip' presence-footsteps-res r5b resourcepacks PresenceFootstepsOfficial.zip
#solderfile --client 'TerraFirmaCraft Custom Footsteps 1.1.zip' tfc-custom-footsteps 1.1 resourcepacks

#solderfile 'InvTweaksCompatibility.xml' tfc-invtweaks-config config
#stagezipdata 'Bibliocraft-TFC_recipes_v1.0.zip'
#solderfile --staged 'Bibliocraft-TFC_recipes.zs' tfc-bibliocraft v1.0 scripts
...
solderfile --client MechTFC32x.zip mechtfc32x 1.7.10-1 resourcepacks
...
rsync -acvzP --bwlimit=256k mechtfc-mods/ mcmods@kuu.accela.net:/var/www/mcmods/TechnicSolder/public/repo/mods
